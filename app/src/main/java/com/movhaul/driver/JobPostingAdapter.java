...
public class JobPostingAdapter extends ArrayAdapter<MV_Datas> {
    Context context;
    private ArrayList<MV_Datas> ar_mv_datas;
    private Activity act;
    private Dialog dg_bidding, dialog2,dg_road_confirm;
    private TextView d2_tv_dialog2;
    private EditText et_bidding, et_driver_id;
    Typeface tf;
    private MV_Datas mv_datas;
    ProgressDialog mProgressDialog;
    SharedPreferences sharedPreferences;
    SharedPreferences.Editor editor;
    private String id, token, str_bidding_cost, str_booking_id;
    private String vec_type;
    private LinearLayout lt_goods_type, lt_nearby;
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        com.rey.material.widget.TextView tv_title_pickup = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_title_pickup);
        com.rey.material.widget.TextView tv_title_drop = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_title_drop);
        com.rey.material.widget.TextView tv_title_date = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_title_date);
        com.rey.material.widget.TextView tv_title_pick_txt = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_book_from_txt);
        com.rey.material.widget.TextView tv_title_drop_txt = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_book_to_txt);
        com.rey.material.widget.TextView tv_title_date_txt = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_date);
        com.rey.material.widget.TextView tv_title_more = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_seemore);

        com.rey.material.widget.TextView tv_content_pickup = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_content_pickup);
        com.rey.material.widget.TextView tv_content_drop = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_content_drop);
        com.rey.material.widget.TextView tv_content_goodstype = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_content_goodstype);
        com.rey.material.widget.TextView tv_content_date = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_content_date);
        com.rey.material.widget.TextView tv_content_time = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_content_time);
        com.rey.material.widget.TextView tv_content_desc = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_content_desc);
       ...
       // lt_nearby1 = (LinearLayout) cell.findViewById(R.id.layout_nearby1);
        ...
        com.rey.material.widget.TextView tv_content_desc_txt = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_nearby_txt);
        com.rey.material.widget.TextView tv_content_pickup_txt = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_pickup_txt);
        com.rey.material.widget.TextView tv_content_drop_txt = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_drop_txt);
        com.rey.material.widget.TextView tv_content_goods_txt = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_goods_txt);
        com.rey.material.widget.TextView tv_content_time_txt = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_time_txt);
        com.rey.material.widget.TextView tv_content_date_txt = (com.rey.material.widget.TextView) cell.findViewById(R.id.textview_book_date_txt);
        ...
        Button btn_bidding_confirm = (Button) dg_bidding.findViewById(R.id.button_confirm);
        ImageView btn_close1 = (ImageView) dg_bidding.findViewById(R.id.button_close);
        TextView tv_dialog1 = (TextView) dg_bidding.findViewById(R.id.textView_1);
        et_bidding = (EditText) dg_bidding.findViewById(R.id.edittext_bidding);
        TextView tv_dialog4 = (TextView) dg_bidding.findViewById(R.id.textView_4);
        ...
        Button d2_btn_ok = (Button) dialog2.findViewById(R.id.button_ok);
        ImageView btn_close2 = (ImageView) dialog2.findViewById(R.id.button_close);
        TextView d2_tv_dialog1 = (TextView) dialog2.findViewById(R.id.textView_1);
        d2_tv_dialog2 = (TextView) dialog2.findViewById(R.id.textView_2);
        TextView d2_tv_dialog3 = (TextView) dialog2.findViewById(R.id.textView_3);
        TextView d2_tv_dialog4 = (TextView) dialog2.findViewById(R.id.textView_4);
