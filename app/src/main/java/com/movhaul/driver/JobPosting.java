 ...
 * shows list of customer posted jobs.
 */
...
public class JobPosting extends Activity {
    ...
    //shows jobs list posted by customers nearby 100 mile radius
    class show_jobs_task extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                //by default radius will be 100 mile , (increasing radius is discuss with clients and how they want.
