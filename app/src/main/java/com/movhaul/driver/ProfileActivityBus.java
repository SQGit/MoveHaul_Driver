 ...
 * profile activity for bus
 * in bus only two parts and limited from truck so bus profile activity is separated.
 * everything same as truck profile except some (bus has two sides photo only,...)
 */
