...
public class ProfileActivityBus extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.vineture.movhaul.driver.R.layout.activity_profile_bus);
        ...
        tv_bk_txt = (TextView) findViewById(com.vineture.movhaul.driver.R.id.textview);
        ...
        iv_vec_inside = (ImageView) findViewById(com.vineture.movhaul.driver.R.id.imageview_vechile_inside);
        ...
        iv_prf_bg = (ImageView) findViewById(com.vineture.movhaul.driver.R.id.prof_bg);
        ...
        if (vec_type.equals("Bus")) {
            ...
            iv_vec_inside.setImageResource(com.vineture.movhaul.driver.R.drawable.bus_inside);
            iv_prf_bg.setBackgroundResource(com.vineture.movhaul.driver.R.drawable.bus_profile_bg);
            url_data = "busdriver";

        } else if (vec_type.equals("Road")) {
            tv_bk_txt.setText("Side");
            iv_vec_inside.setImageResource(com.vineture.movhaul.driver.R.drawable.road_side);
            iv_prf_bg.setBackgroundResource(com.vineture.movhaul.driver.R.drawable.road_assis_bg);
            url_data = "assistance";
        }
        ...
        btn_update.setOnClickListener(new View.OnClickListener() {
                                          ...
                                          public void onClick(View view) {
                                              ...
                                              if (!(str_contact.isEmpty() || str_contact.length() < 10)) {
                                                                  ...
                                                                  if (str_vec_front != null || !(sharedPreferences.getString("truck_front", "").equals(""))) {
                                                                      if (str_vec_rc != null || !(sharedPreferences.getString("bus_rc", "").equals(""))) {
                                                                          if (str_vec_ins != null || !(sharedPreferences.getString("bus_ins", "").equals(""))) {
                                                                              ...
                                                                              snackbar.show();
                                                                              tv_snack.setText(com.vineture.movhaul.driver.R.string.veaas);
                                                                          }
                                                                      } else {
                                                                          snackbar.show();
                                                                          tv_snack.setText(com.vineture.movhaul.driver.R.string.adc);
                                                                      }


                                                                  } else {
                                                                      snackbar.show();
                                                                      tv_snack.setText(com.vineture.movhaul.driver.R.string.aewc);
                                                                  }


                                                              } else {
                                                                  snackbar.show();
                                                                  tv_snack.setText(com.vineture.movhaul.driver.R.string.awev);
                                                              }
                                                          } else {
                                                              snackbar.show();
                                                              tv_snack.setText(com.vineture.movhaul.driver.R.string.dvea);
                                                          }
                                                      } else {

                                                          snackbar.show();
                                                          tv_snack.setText(com.vineture.movhaul.driver.R.string.vea);
                                                          et_address.requestFocus();

                                                      }
                                                  } else {
                                                      snackbar.show();
                                                      tv_snack.setText(com.vineture.movhaul.driver.R.string.fve);
                                                  ...
                                                  snackbar.show();
                                                  tv_snack.setText(com.vineture.movhaul.driver.R.string.adf);
